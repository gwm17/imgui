...
bool ImGui::ButtonEx(ImStrv label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    IMGUI_TEST_ENGINE_ITEM_INFO(id, label.Begin, g.LastItemData.StatusFlags);
    return pressed;
}
...
bool ImGui::Checkbox(ImStrv label, bool* v)
{
    ...
    IMGUI_TEST_ENGINE_ITEM_INFO(id, label.Begin, g.LastItemData.StatusFlags | ImGuiItemStatusFlags_Checkable | (*v ? ImGuiItemStatusFlags_Checked : 0));
    return pressed;
}
...
bool ImGui::TreeNodeBehavior(ImGuiID id, ImGuiTreeNodeFlags flags, ImStrv label)
{
    ...
    if (!item_add)
    {
        ...
        IMGUI_TEST_ENGINE_ITEM_INFO(g.LastItemData.ID, label.Begin, g.LastItemData.StatusFlags | (is_leaf ? 0 : ImGuiItemStatusFlags_Openable) | (is_open ? ImGuiItemStatusFlags_Opened : 0));
        return is_open;
    }
    ...
    if (is_open && !(flags & ImGuiTreeNodeFlags_NoTreePushOnOpen))
        TreePushOverrideID(id);
    IMGUI_TEST_ENGINE_ITEM_INFO(id, label.Begin, g.LastItemData.StatusFlags | (is_leaf ? 0 : ImGuiItemStatusFlags_Openable) | (is_open ? ImGuiItemStatusFlags_Opened : 0));
    return is_open;
}
...
bool ImGui::BeginMenu(ImStrv label, bool enabled)
{
    ...
    IMGUI_TEST_ENGINE_ITEM_INFO(id, label.Begin, g.LastItemData.StatusFlags | ImGuiItemStatusFlags_Openable | (menu_is_open ? ImGuiItemStatusFlags_Opened : 0));
    PopID();
...
bool ImGui::MenuItemEx(ImStrv label, ImStrv icon, ImStrv shortcut, bool selected, bool enabled)
{
    ...
    IMGUI_TEST_ENGINE_ITEM_INFO(g.LastItemData.ID, label.Begin, g.LastItemData.StatusFlags | ImGuiItemStatusFlags_Checkable | (selected ? ImGuiItemStatusFlags_Checked : 0));
    if (!enabled)
        PopDisabled();
    PopID();
